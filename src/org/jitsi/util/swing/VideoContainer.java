    ...
    extends TransparentPanel
{
    ...
    public VideoContainer(Component noVideoComponent, boolean conference)
    {
        ...
        // solve the bug caused by 
        // If the size of this Component is tiny enough to crash sws_scale,
        // then it may cause issues with other functionality as well. Stay on
        // the safe side.
        // IN JAWTRendererVideoComponent paint
        // otherwise, the panel will not be painted the first time when it is inserted and stay dark screen
        // becasue getheight() getwidth are 1
        this.setSize(SwScale.MIN_SWS_SCALE_HEIGHT_OR_WIDTH,  SwScale.MIN_SWS_SCALE_HEIGHT_OR_WIDTH);
