...
public class AVTransmit2
{
        ...
        throws Exception
    {
        ...
        // add by jason for audio only
        System.out.println("media type: " + mediaTypes);
        MediaType [] newmediaTypes = new MediaType[1];
        newmediaTypes[0] = mediaTypes[2];
        mediaTypes = newmediaTypes;
        
        for (MediaType mediaType : mediaTypes)
        {
        	System.out.println("mediatype for creating media stream: " + mediaType);
             ...
             */
            MediaDevice device
                = mediaService.getDefaultDevice(mediaType, MediaUseCase.DESKTOP);

            List<MediaFormat> formts = device.getSupportedFormats();
            
            System.out.println("Format using: " + device.getFormat());
